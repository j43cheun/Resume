...
% public repo. If that file isn't present (e.g. in CI, a fresh clone, or the public
% build linked from LinkedIn), the phone number is omitted entirely rather than
% shown as a placeholder — \resumemobile is only defined if personal-info.tex
% defines it. The email keeps a placeholder default since \email is not optional.
...
\ifdefined\resumemobile\mobile{\resumemobile}\fi
\email{\resumeemail}
